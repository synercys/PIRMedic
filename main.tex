...
\input{dependencies/packages}
\input{dependencies/custom_commands}
\AtBeginDocument{%
...
\input{Sections/0000_Authors}
\input{Sections/00_Abstract}
\input{dependencies/acm_headers}
\maketitle
\input{Sections/01_Introduction}
\input{Sections/02_RelatedWork}
%%% Outline of paper
\input{Sections/031-032_pir_sensors}
\input{Sections/033-034_failures}
\input{Sections/04_CharacterizeFailures}
\input{Sections/05_FaultDetection_and_Diagnosis}
\input{Sections/06_Implementation}
\input{Sections/071-072_Evaluation}
\input{Sections/073-074_Evaluation}
