...
\input{Sections/Failures}
\input{Sections/CharacterizeFailures}
\input{Sections/FaultDetection}
\input{Sections/Implementation}
\input{Sections/05_ExperimentalSetup}
\input{Sections/06_CharacterizationofFaults}
\input{Sections/075_Discussion}
